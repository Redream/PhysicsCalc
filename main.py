...
def rocket_up_time(vi, vf, a):
    ...
    print("change in velocity ({0}^2 - {1}^2) m/s = {2} m/s".format(vf, vi, str(vf ** 2 - vi ** 2)))
    print("acceleration is constant so multiply by 2 (2 x {0}) ms^-2 = {1} m/s^-2".format(a, str(2 * a)))
